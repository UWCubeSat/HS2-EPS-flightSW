...
BatteryMeasurements BQ25756::BatteryMonitor::getMeasurements() {
...
{
        bq.adc.enableADCReadingForOneshot();
...
{
    bq.adc.enableADCReadingForOneshot();
    int16_t data = read16bitRegister(IAC_ADC);
...
BQ25756::BatteryMonitor::ChargingStatus 
BQ25756::BatteryMonitor::getChargingStatus()  
{
    bq.adc.enableADCReadingForOneshot();
